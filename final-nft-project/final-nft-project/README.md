...
```
dfx canister call qjdve-lqaaa-aaaaa-aaaeq-cai transferOwnership '(principal "r7inp-6aaaa-aaaaa-aaabq-cai", true)'
```

# Conneting to the Token Canister
To use buy functionality you have to run token-local project as well,download it and use
```
dfx deploy
npm start
```
